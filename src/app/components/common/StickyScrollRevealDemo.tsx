    ...
    <div className="w-full lg:p-20 p-6 md:10">
      {content.map((item, index) => (
        ...
        >
          ...
          <div className="gap-10 flex flex-col w-[50%] justify-center item-center">
            <div className="w-full flex justify-center item-center font-bold text-3xl text-slate-600 line-height-10">
              {item.title}
            </div>
      ...
      {content.map((item, index) => (
        <div
          ...
          key={index}
        >
          <div className="w-full flex justify-center item-center font-bold md:text-3xl text-xl text-slate-600 line-height-10">
            {item.title}
          </div>
